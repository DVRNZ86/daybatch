...
// EPOCH (B3 contract, PERMANENT — never change): 11 July 2026, device-local.
// That day's batch is puzzle #1. Day difference is computed via UTC stamps of
// the local calendar date so DST transitions can never skew the count.
export const EPOCH=[2026,6,11]; // [year, monthIndex, day]
